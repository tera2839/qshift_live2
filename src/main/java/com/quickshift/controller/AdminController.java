...
>>>>>>> e2089f548ec708cec6e496c0fa3c3e1deda457f7
	...
	public String showEditAdminRequest(
		...
		for(AdminRequest request : requestList) {
			String str = request.getCalendar().getCdate() + ":" + request.getTimeplan().getId() + ":" + request.getNum();
			requests.add(str);
		}
...
>>>>>>> e2089f548ec708cec6e496c0fa3c3e1deda457f7
	...
	public String completeEditAdminRequest(
			@RequestParam("requestShift") String[] requests,
			@RequestParam("newRequest") String[] newRequests
			) {
		...
		for(String request : requests) {
			...
			String calendarId = aSession.getYear() + aSession.getMonth() + date;
